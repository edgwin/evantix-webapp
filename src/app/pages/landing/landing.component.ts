...
export class LandingComponent {
  ...
  constructor(private router: Router, private meta: Meta, private title: Title) {
    ...
    this.meta.updateTag({ name: 'description', content: 'Evantix te permite crear invitaciones digitales personalizadas para bodas, XV años, bautizos y más. Diseños elegantes, IA integrada, envío por WhatsApp y gestión de invitados desde $999 MXN.' });
    this.meta.updateTag({ name: 'keywords', content: 'invitaciones digitales, invitaciones boda, invitaciones XV años, eventos, RSVP digital, WhatsApp invitaciones, mesa de invitados, Evantix' });
